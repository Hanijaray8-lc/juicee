...
export const getLoveBotResponse = async (userMessage, history = []) => {
  ...
  if (!apiKey) {
    console.error('REACT_APP_GROQ_API_KEY is not defined in environment variables.');
    return "⚠️ Groq API key is not configured. Please ensure REACT_APP_GROQ_API_KEY is set in your .env file.";
  }
